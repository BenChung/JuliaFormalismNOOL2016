...
\newcommand{\exact}[1]{\M{\llbracket #1 \rrbracket_{\xt{exact}}}}
\newcommand{\usable}[1]{\M{\llbracket #1 \rrbracket_{\xt{usable}}}}
...
\begin{figure}
\begin{mathpar}
\inferrule*[lab={\tiny TAbs}]{ \real{A} \cup 
	\bigcap_{C <: A} \usable{C} 
	\bigcap_{A' <: A} \usable{A'} 
	\cap \usable{\any} = A}{ \OK{\abstype{A}{t}} }
