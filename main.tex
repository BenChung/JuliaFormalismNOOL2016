...
Types (\xt{t}) in \jolt\space are either a name of an abstract type (\xt{A}) or a concrete type (\xt{C}), 
or the \any\space keyword, while the expressions (\xt{e}) include varibles, object creation, and method invocation. 
The declarations of \jolt\space consists of abstract type, concrete type, and method definition. 

The declarations is probably the most important part, since 
