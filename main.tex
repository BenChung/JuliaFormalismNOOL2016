...
by synthesizing interfaces from concrete implementations. \jolt\space can rule
out some type errors in existing code without any new annotations, providing extra safety for free.
\end{abstract}
...
However, the assumption that \xt{a} is always safe on a \xt{A} is not true
